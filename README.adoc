...
- [guardian-agent-prompts](https://github.com/milkomida77/guardian-agent-prompts) - 49 production-tested AI agent system prompts for data engineering workflow orchestration, automated ETL pipeline management, and multi-agent coordination. MIT licensed.
