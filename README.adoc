...
* https://github.com/bruin-data/bruin[Bruin] - End-to-end data pipeline tool combining ingestion (50+ sources), SQL/Python transformations, and built-in data quality checks in a single CLI.
