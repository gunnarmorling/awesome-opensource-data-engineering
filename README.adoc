...
* https://github.com/slingdata-io/sling-cli[Sling] - Open-source EL(T) CLI and Go library for high-performance data movement between 40+ databases, file systems, and APIs. Single binary; no infrastructure required.
