...
* https://github.com/joachimhodana/dbt-doctor[dbt-doctor] - CLI linter and health scorer for dbt projects (SQL, YAML, and Jinja), with optional SQLFluff integration, CI gates, and a 0-100 project health score.
