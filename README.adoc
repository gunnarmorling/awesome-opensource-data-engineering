...
* https://github.com/ModernRelay/omnigraph[Omnigraph] - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
