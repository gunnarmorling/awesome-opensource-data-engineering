...
=== Collections
* https://www.data-landscape.com/[Data Landscape] - Interactive map of the open standards behind a modern data architecture (contracts, schema, query, processing, table formats, lineage, etc.).
