...
* https://github.com/provero-org/provero[Provero] - A vendor-neutral, declarative data quality engine. Define checks in YAML, run anywhere. Supports 16 built-in check types, SQL batch optimization, anomaly detection, and data contracts.
